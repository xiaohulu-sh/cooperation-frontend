<template>
  <div :class="c.dataBlock">
    <h2 :class="[c.imgTitle, s.title1]">直播记录</h2>
    <div :class="c.block1">
      <ul :class="c.dataTabs" style="padding-top:30px">
        <li :class="c.dataTabActive">全部</li>
        <li>销售额最高</li>
        <li>订单数最多</li>
        <li>客单价最高</li>
        <li>观众数最多</li>
        ...
        <ul :class="s.list1">
          <li v-for="(_, index) in [, , ,]" :key="index">
            ...
            <div :class="s.content">
              ...
              <div :class="s.alert">本场直播存在数据异常</div>
            </div>
          </li>
        </ul>
      </div>
